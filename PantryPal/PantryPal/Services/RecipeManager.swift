...
class RecipeManager : ObservableObject{
    ...
    func getURL() -> String{
        ...
        let baseURL = "https://api.edamam.com/api/recipes/v2?type=public&app_id=193be525&app_key=***REMOVED***"
    ...
    func getURL(specification:String) -> String{
        ...
        let baseURL = "https://api.edamam.com/api/recipes/v2?type=public&app_id=193be525&app_key=***REMOVED***" + specification
